...
class Cashbill_model extends CI_Model {


        var $table = 'cashbill_details';
...
public function delete_by_id($id)
{
    ...
    {
        $this->db->insert('cashbill_details',$data);
        return $this->db->affected_rows()!=1? false:true;
    }
    ...
    public function update_invoice($data,$id)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('cashbill_details',$data);
        return $this->db->affected_rows()!=1? false:true;
    }
       ...
       public function search_pending()
    {
        ...
        return $query= $this->db->where('balance >',0)->get('cashbill_details')->result_array();
