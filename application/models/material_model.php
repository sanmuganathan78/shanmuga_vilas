...
return $query=$this->db->get('material_details')->result_array();
...
return $query->result_array();
	...
	{
          $this->db->insert('material_details',$data);
  ...
  {       
          $this->db->where('id',$id);
          $this->db->update('material_details',$data);
          return $this->db->affected_rows()!=1? false:true;
  }
