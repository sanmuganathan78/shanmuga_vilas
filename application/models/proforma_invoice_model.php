...
class Proforma_invoice_model extends CI_Model {
        ...
        var $table = 'proforma_invoice_details';
...
return $query=$this->db->get('proforma_invoice_details')->result_array();
...
public function delete_by_id($id)
{
    ...
    {
        $this->db->insert('proforma_invoice_details',$data);
        return $this->db->affected_rows()!=1? false:true;
    }
    ...
    public function update_invoice($data,$id)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('proforma_invoice_details',$data);
        return $this->db->affected_rows()!=1? false:true;
    }
       ...
       public function search_pending()
    {
        ...
        return $query= $this->db->where('balance >',0)->get('proforma_invoice_details')->result_array();
