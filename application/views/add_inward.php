...
?>
								...
								<div class="row">
									<form class="form-horizontal" data-parsley-validate novalidate  method="post"    action="<?php echo base_url();?>inward/insert" >
											...
											<div class="col-md-8 forms">
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<input type="text" class="form-control" required name="customerdcno" id="customerdcno" value="" style="width:148px;">
										...
										<table class="responsive table" width="100%">
											...
											<tbody>
												<tr>
													...
													<td><input class="form-control" parsley-trigger="change" autofocus required id="itemname" type="text" name="itemname[]" value=""><div id="itemname_valid"></div><input type="hidden" name="item_desc[]" value="" style="margin-top: 2px;" class="form-control"></td>
													<td><input class="form-control" readonly id="uom" type="text" name="uom[]"  autocomplete="off" style=" background-color: #eee !important;"><div id="qty_valid"></div></td>
										...
										<div class="col-sm-offset-11">
											<button type="button" class="btn btn-info add" style="margin-left: 33px;"><i class="fa fa-plus"></i></button>
	...
	$(document).ready(function() {
		...
		$('.add').click(function(){
			...
			$('#hide').val(total);
			var tbody=$('#append');
			$('<tr><td><input class="form-control" parsley-trigger="change" required id="itemname'+total+'" type="text" name="itemname[]" value=""><div id="itemname_valid'+total+'"></div><input type="hidden" name="item_desc[]" value="" style="margin-top: 2px;" class="form-control"></td> <td><input class="form-control" readonly id="uom'+total+'" type="text" name="uom[]" style=" background-color: #eee !important;" autocomplete="off"><div id="qty_valid"></div></td><td><input class="form-control decimal" required id="qty'+total+'" type="text" parsley-trigger="change" required name="qty[]" autocomplete="off" value="" onkeypress="return isNumberKey(event)" required ><div id="qty_valid'+total+'"></td>'
