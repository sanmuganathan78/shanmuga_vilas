					...
					<div class="row">
						<div class="col-sm-12">
							<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
								...
								<div class="card-box">
									<div class="row">
										<form class="horizontal-form"  method="post" name="logoForm" id="logoForm" action="<?php echo base_url();?>purchase/insert" -onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>purchase'; },2000)" data-parsley-validate novalidate><!---->
											<input type="hidden" class="form-control" name="purchaseno" id="purchaseno" value="<?php echo $invoiceno;?>" 
                                             ...
                                             <div class="row">
	                                            <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
														<label>Supplier  Name<a target="_blank" href="<?php echo base_url();?>customer"> (Add Party)</a></label>
                                                    ...
                                                    <div class="col-md-2">
														...
														<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="invoicedate" id="invoicedate" value="" >
                                                    </div>
