					...
					<div class="col-sm-12">
						<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
							<header class="panel-heading" style="color:rgb(255, 255, 255)">
								<i class="zmdi zmdi-apps">&nbsp;Category Reports</i>
								<a href="javascript:;" data-toggle="collapse" data-target="#form_div" style="color:white;" class="pull-right"> <i class="fa fa-plus"></i> Add Category</a>
							</header>
											...
											<form class="form-horizontal"  method="post" action="<?php echo base_url();?>category/insert">
												<div class="form-group">
													...
													<div class="col-md-3">
														...
														<div id="category_valid1"></div>
													</div>
												</div>
												<div class="col-sm-offset-2">
													<button  class="btn btn-info" id="submit">Add Category</button>
	...
	{
	category.focus();
	$('#category_valid').html('<span><font color="red"> Enter the category  </span>');
