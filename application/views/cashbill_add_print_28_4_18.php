...
foreach ($datas as $profileimage)
  ...
  <table width="750" border="0" style="" align="center">
    <tr>
      ...
      <td width="250" align="center" style="font-size:20px;font-weight:bold;">CASH BILL INVOICE</td>
...
<table width="750" border="0" style="border-left:1px solid black;border-collapse: collapse;border-right:1px solid black;" align="center" cellpadding="1">
    ...
    <tr>
        <td width="700" rowspan="2" valign="top" style="font-size:14px;border-right:1px solid black;"><?php echo @$addresss1;?><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mobile No : <?php echo @$mobileno;?></td>
