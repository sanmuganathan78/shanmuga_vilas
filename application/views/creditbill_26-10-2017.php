          ...
          <tr style="height:1px;<?php echo $hide;?>">
            ...
            <td align="right" valign="bottom" style="border-bottom:1px solid black;border-right:1px solid black;padding:5px;font-size:13px;font-weight:bold;"><small>Taxable Amount</small></td>     
             ...
             <tr >
              ...
              <td align="right" style="border-bottom:1px solid black;border-right:1px solid black;padding:5px;font-size:14px;font-weight:bold;">&nbsp;<?php echo  number_format(array_sum($totamt),2); ?></td>
    ...
    <table width="750" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
      ...
      <tr>
          ...
          <tr>
            ...
            <td align="right" style=""><span style="font-size:16px;font-weight:bold;">Loading and Packing Charges&nbsp;&nbsp;:</span></td>
            <td align="right" ">&nbsp;<b><?php if($bil->loadingtotal!="") { echo  number_format($bil->loadingtotal,2); } else { echo "0.00"; }?></b></td>
          </tr>
          <tr>
