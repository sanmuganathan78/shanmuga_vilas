...
<div class="form-group">
<label >Date</label>
<input type="text" class="form-control datepicker-autoclose" name="invoicedate" parsley-trigger="change" id="datepicker-autoclose" required="" value="<?php echo date('d-m-Y',strtotime($r['invoicedate']));?>">
</div>
</div>
...
<input type="text" class="form-control" parsley-trigger="change" required name="customername" id="customername" value="<?php echo $r['customername'];?>"	>
...
<td><input class="itemname_class" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>"  value="<?php echo @$itemname[$i];?>" <?php echo $readonly;?> style="border:1px solid #605f5f;" required type="text" name="itemname[]" value="" ><div id="itemname_valid<?php echo $i;?>"></div></td>


<td><input class="qty_class decimals" data-id="<?php echo $i;?>" id="qty<?php echo $i;?>"   parsley-trigger="change" value="<?php echo @$qty[$i];?>" <?php echo $readonly;?> required type="text" name="qty[]"   autocomplete="off" ><input class="" id="qtys0" type="hidden" name="qtys[]"><div id="qty_valid0"></div></td>  
...
<td><input class="rate_class decimals" data-id="<?php echo $i;?>" parsley-trigger="change" required id="rate<?php echo $i;?>"  value="<?php echo @$rate[$i];?>" <?php echo $readonly;?>  type="text" name="rate[]"   autocomplete="off"><div id="rate_valid0"></div></td>
...
<div class="col-sm-7">
<input class="form-control"  type="text" name="othercharges" id="othercharges"   placeholder="0" -onkeypress="return isNumber(event)" value="<?php echo $r['othercharges'];?>" onfocus="if(this.value == '0') { this.value = ''; }" onblur="if(this.value == '') { this.value = '0'; }">
</div>
</div>
<br>
<br>  
