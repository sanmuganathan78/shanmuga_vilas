	...
	?>
											...
											<div class="table-responsive myform" >
												<table class="table">
													...
													<tbody>
														...
														?>
														<tr>
															<td><input class="" id="hsnno<?php echo $i;?>" style="border:1px solid #605f5f;" type="text"  name="hsnno[]" value="<?php echo $hsnno[$i];?>"><input class="form-control"  id="itemno<?php echo $i;?>" type="hidden" name="itemno[]" value=""><input class="form-control"  id="ida<?php echo $i;?>" type="hidden"  value="<?php echo $i;?>">
															...
															<td class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals cgstClass" data-id="<?php echo $i;?>" value="<?php echo $cgst[$i];?>" id="cgst<?php echo $i;?>"  type="text" name="cgst[]" style="border:1px solid #605f5f;" autocomplete="off" ><div id="cgst_valid"></div></td>
															...
															<td class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals igstClass" data-id="<?php echo $i;?>" value="<?php echo $sgstamt[$i];?>" id="sgstamount<?php echo $i;?>"  type="text" name="sgstamount[]" autocomplete="off" style="border:1px solid #605f5f;">
		...
		$(document).ready(function() {
			...
			$('.add').click(function(){
				...
				$(' <tr>'
				+'<td><input class="" id="hsnno'+total+'" style="border:1px solid #605f5f;" type="text" name="hsnno[]" value="" style="border:1px solid #605f5f;"><div id="hsnno_valid"></div></td>'
				...
				+'<td class="sgst" style="display:'+samples1+';"><input class="cgstClass decimals" data-id="'+total+'"  id="cgst'+total+'"  type="text" name="cgst[]" value="0" style="border:1px solid #605f5f;" autocomplete="off" ><div id="cgst_valid'+total+'"></div></td>'
				...
				+'<td class="igst" style="display:'+samples+';"><input class="decimals igstClass" data-id="'+total+'" id="igst'+total+'"  type="text" name="igst[]"  style="border:1px solid #605f5f;" value="0" autocomplete="off" ><div id="igst_valid'+total+'"></div></td>'
