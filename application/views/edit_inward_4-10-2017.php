          ...
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
             <?php foreach ($result as $rows) {  ?>
              <i class="zmdi zmdi-assignment-o">&nbsp;Edit Inward (<?php echo $rows['inwardno'];?>)</i>
              <?php } ?>
            </header>
            <div class="card-box">
              <div class="row">
                  ...
                  <table class="responsive table" width="100%">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><input class="form-control" parsley-trigger="change" readonly id="hsnno<?php echo $i;?>" type="text" name="hsnno[]" value="<?php echo $hsnno[$i];?>">
                          ...
                          <div id="itemname_valid<?php echo $i;?>"></div></td>
