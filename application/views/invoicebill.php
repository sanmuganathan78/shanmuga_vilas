...
<tr>
<td width="200" ><img src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" width="120" height="100" alt="logo" /></td>
...
<td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;Order Date</td>
</tr>
<tr>
...
<td style="font-size:14px;border-right:1px solid black;" ><b>&nbsp;&nbsp;&nbsp;<?php $odate=$bil->orderdate; if($odate == '1970-01-01'){echo "-";}else{ $order_date=date('d/m/Y',strtotime($odate)); echo $order_date;}?></b></td>
</tr>
<tr>
