...
foreach ($datas as $profileimage)
  ...
  <table width="750" border="0" id="backButon" align="center">
	<tr>
		<td align="right"><a -class="btn btn-success" href="<?php echo base_url().'invoice';?>">Go back to Add Invoice</a><?php if($fromDirectBill==0) { ?>&nbsp;<a -class="btn btn-primary" href="javascript:window.close();">Close</a> <?php } ?></td>
	</tr>
  </table>
