  ...
  <div class="col-sm-12">
    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
      <header class="panel-heading" style="color:rgb(255, 255, 255)">
        <i class="zmdi zmdi-view-headline">&nbsp;Job Inward Reports</i>
    </header>
...
{?><tr>
<td><?php echo $i++;?></td>
<td><?php echo date('d-m-Y',strtotime($u['jobinwarddate']));?></td>
<td><?php echo $u['jobtype'];?></td>
<td><?php echo $u['jobinwardno'];?></td>
...
function view_person(id)
{
    ...
    $.post('<?php echo base_url();?>jobinward/viewbilling',{'id':id},function(data){
