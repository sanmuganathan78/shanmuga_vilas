...
$i=1;
foreach($view as $u)
  @$joborderdate=$this->db->select('joborderdate')->where('id',$u['insertid'])->get('job_details')->row()->joborderdate;
  @$vendors=$this->db->select('vendors')->where('id',$u['insertid'])->get('job_details')->row()->vendors;
 @$operatorname=$this->db->select('operatorname')->where('id',$u['insertid'])->get('job_details')->row()->operatorname;
{?><tr>
<td><?php echo $i++;?></td>
<td><?php echo date('d-m-Y',strtotime($joborderdate));?></td>
<td><?php echo $u['joborderno'];?></td>
<td><?php echo $vendors;?> <?php echo $operatorname;?></td>
<td><?php echo $u['returnitemname'];?></td>
<td><?php echo $u['returnqty'];?></td>
