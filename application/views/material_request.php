...
<input type="hidden"  class="form-control" name="dcno" id="dcno" value="<?php echo $cusno;?>">
...
<div class="form-group">
<label > Date</label>
<input type="text"  class="form-control datepicker-autoclose" name="dcdate" id="dcdate" value="<?php echo date('d-m-Y');?>">
</div>
</div>
...
<input type="text" parsley-trigger="change"  class="form-control" name="cusname" id="cusnam" value="">
...
<table class="responsive table" width="100%">
		...
		<tbody>
			<tr>
				...
				<td><input class="form-control clear itemname_class" parsley-trigger="change"  id="itemname0" type="text" data-id="0" name="itemname[]" value="">
				...
				<td><input class="form-control clear decimal" parsley-trigger="change"  id="qty0" type="text" name="qty[]" value=""   autocomplete="off">
				<div id="qty_valid"></div></td>
	...
	<div class="col-sm-offset-4">
		<input type="submit" class="btn btn-info" id="submit" name="save" value="save">
