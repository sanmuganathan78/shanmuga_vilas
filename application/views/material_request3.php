...
<i class="zmdi zmdi-assignment-o">&nbsp;Material Request (<?php echo $cusno;?>)</i>
</header>
<div class="card-box" style="min-height: 500px;">
<div class="row">
<form class="form-horizontal"  data-parsley-validate novalidate  method="post" target="_blank" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>material_request'; },2000)"  action="<?php echo base_url();?>material_request/insert" >
...
<input type="text" parsley-trigger="change" required class="form-control" name="cusname" id="cusnam" value="">
...
<select id="salestype" class="form-control" name="salestype">
	                                        <option value="package">Select </option>
                                            <option value="package">SWEETS </option>
                                             <option value="item">BAKES</option>
...
<table class="responsive table" width="100%">
		...
		<tbody>
			<tr>
				...
				<td><input class="form-control clear itemname_class" parsley-trigger="change" required id="itemname0" type="text" data-id="0" name="itemname[]" value="">
				<div id="itemname_valid"></div><input class="form-control" type="text" name="item_desc[]" value="" style="margin-top: 2px;" ></td>
				<td><input class="form-control clear" readonly id="uom0" type="text" name="uom[]"  autocomplete="off">
				<div id="qty_valid"></div></td>
				<td><input class="form-control clear decimal" parsley-trigger="change" required id="qty0" type="text" name="qty[]" value=""   autocomplete="off">
				<div id="qty_valid"></div></td>
				<td><input class="form-control clear" id="remarks0" type="text" name="remarks[]"  autocomplete="off">
				<div id="qty_valid"></div></td>
	...
	<div class="col-sm-offset-4">
		<button type="submit" class="btn btn-info" id="submit" name="save" value="save">Save</button>
