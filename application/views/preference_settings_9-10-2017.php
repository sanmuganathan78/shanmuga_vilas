									...
									<form class="form-horizontal"  enctype='multipart/form-data' method="post" action="<?php echo base_url();?>preference/insert" data-parsley-validate novalidate>
										...
										<div class="form-group">
											...
											<div class="col-sm-offset-5">
												<button  class="btn btn-info" id="submit" type="button" onclick="javascript:resetFun();"><i class="fa fa-refresh"></i> Reset</button>
											</div>
										<!--</form>-->
							...
							<div class="card-box">
								<div class="row">
									<form class="form-horizontal"  method="post" action="<?php echo base_url();?>preference/resetTables" onsubmit="return resetSw()">
										...
										<div class="row">
											<div class="col-md-4">&nbsp;</div>
											<!--<div class="col-md-3"><label class="checkbox-inline"><input type="checkbox" name="resetChkBox[]"  value="debitorcredit">Debit (or) Credit Note Reports</label></div>-->
