       ...
       <input class="" id="gsttypes"  type="hidden" value="<?php echo $gsttype;?>" style="width:70px;">
        <div class="table-responsive">
                      ...
                      <?php
                        ...
                        <tr>
                         ...
                         <input class="form-control" parsley-trigger="change" readonly id="id<?php echo $rows['id'];?>" type="hidden" name="id[]" value="<?php echo $rows['id'];?>"> 
                          ...
                          <td><input class="" id="itemname<?php echo $rows['id'];?>" parsley-trigger="change" readonly  style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" value="<?php echo $rows['itemname'];?>" ><div id="itemname_valid"></div>
                 ...
                 <div class="col-sm-offset-4">
                        ...
                        <button  class="btn btn-primary"  name="print" id="print" value="print">Print Proforma  Invoice</button>
                      </div>
