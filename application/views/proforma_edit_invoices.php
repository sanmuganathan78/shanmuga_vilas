					...
					<div class="row">
						<div class="col-sm-12">
							<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
								...
								<i class="zmdi zmdi-shopping-cart">&nbsp;Edit Proforma Invoice </i> - <?php echo $r['invoiceno'];?>
								</header>
								<div class="card-box">
									<div class="row">
										<form class="horizontal-form" name="editForm"  method="post" action="<?php echo base_url();?>proforma_invoice/update" data-parsley-validate novalidate >
											...
											<input type="hidden" name="bill_type" id="bill_type" value="Sales Invoice" >
											...
											<div class="col-sm-offset-4">
												...
												<button  class="btn btn-info" id="submit" name="save" value="save">Update Proforma Invoice</button>
		...
		function call_keyup()
		{
			...
			$(".itemname_class").keyup(function(){
					...
					$( "#itemname"+total).autocomplete({
						source: function(request, response) {
							$.ajax({ 
								url: "<?php echo base_url();?>proforma_invoice/autocomplete_itemname",
						...
						select: function (event, ui) {
							...
							$.post('<?php echo base_url();?>proforma_invoice/get_itemnames',{name:name},function(rest){
							...
							$.post('<?php echo base_url();?>proforma_invoice/get_stockqty',{name:name},function(resst){
								var obj=jQuery.parseJSON(resst);
								$('#qtys').val(obj.balance);
							}); 
							if(name !='')
							{
								$.post('<?php echo base_url();?>proforma_invoice/gets',{name:name},function(res){
									if(res > 0)
									{
