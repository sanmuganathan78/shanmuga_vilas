            ...
            <div class="col-sm-12">
              <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                <header class="panel-heading" style="color:rgb(255, 255, 255)">
                  <i class="zmdi zmdi-view-headline">&nbsp; Proforma Invoice</i> - <?php echo $r['invoiceno'];?>
                </header>
                <div class="card-box">
                  <div class="row">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><input class="" id="itemname" disabled value="<?php echo $itemname[$i];?>" style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" value="" >
							...
							<input disabled value="<?php echo $item_desc[$i];?>" style="width:150px;border:1px solid #605f5f;margin-top:2px;" type="text" >
                          </td>
