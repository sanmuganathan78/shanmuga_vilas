...
foreach ($datas as $profileimage)
  ...
  <table width="1050" id="backButon">
	<tr>
		<td align="right" width="980"><a class="btn btn-success" href="<?php echo base_url().'purchaseorder';?>">Go back to Add Purchase Order</a></td>
		<td align="right"><a class="btn btn-success" href="javascript:window.close();">Close</a></td>
	</tr>
  </table>
  <table width="750" border="0" style="" align="center">
    <tr>
      <td width="250" align="center" style="font-size:20px;font-weight:bold;"></td>
      <td width="250" align="center" style="font-size:20px;font-weight:bold;">Purchase Order</td>
