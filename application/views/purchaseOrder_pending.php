  ...
  <div class="col-sm-12">
    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
      <header class="panel-heading" style="color:rgb(255, 255, 255)">
        <i class="zmdi zmdi-view-headline">&nbsp;Purchase Order Pending</i>
    </header>
...
{?><tr>
<td><?php echo $i++;?></td>
<td><?php echo date('d-m-Y',strtotime($u['purchasedate']));?></td>
<td><?php echo $u['purchaseorderno'];?></td>
<td><?php echo $u['customername'];?></td>
<td><?php echo $u['itemname'];?></td>
<td><?php echo $u['qty'];?></td>
<td><?php echo $u['balaceqty'];?></td>
<td>
<?php 
