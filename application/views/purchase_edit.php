									...
									<form class="horizontal-form myform" name="editForm"  method="post" action="<?php echo base_url();?>purchase/update" data-parsley-validate novalidate>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<select  class="form-control" parsley-trigger="change" required name="gsttype" id="gsttype" >
															...
															<?php /* <option value="<?php echo $vi['gsttype'];?>" selected="selected"><?php echo $vi['gsttype'];?></option>
															<option value="interstate" <?php if($vi['gsttype']=='interstate')echo 'selected';?>>Interstate</option> */ ?>
														</select>
														<script>document.editForm.gsttype.value='<?php echo $vi['gsttype'];?>';</script>
													</div>
												</div>
											</div>
											<div class="col-md-4">
										...
										<table class="table">
											<thead> 
												<tr>
													...
													<th class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;CGST</th>
													<th class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;CGST <br> &nbsp;&nbsp;&nbsp;Amount</th>
													<th class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;SGST</th>
													<th class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;SGST <br>&nbsp;&nbsp;&nbsp;Amount</th>
													<th  class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;IGST</th>
													<th  class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;IGST <br> &nbsp;&nbsp;&nbsp;Amount</th>
													<th>Total</th>
												</tr>  
											</thead>
											<tbody>
												...
												<tr>
													...
													<td>
														<input class="itemname_class" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>" value="<?php echo htmlspecialchars(stripslashes($itemname[$i]));?>" style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" value="" ><div id="itemname_valid<?php echo $i;?>"></div><input type="hidden" id="priceType<?php echo $i;?>" name="priceType[]" value="<?php echo $item_result->priceType;?>" />
													</td>
													<td>
													...
													<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" value="<?php echo $cgst[$i];?>" readonly id="cgst<?php echo $i;?>" required type="text" name="cgst[]" value="" style="width:45px;border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" required><div id="cgst_valid<?php echo $i;?>"></div></td>
													<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" value="<?php echo $cgstamount[$i];?>" id="cgstamount<?php echo $i;?>" required type="text" name="cgstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="width:80px;border:1px solid #605f5f;" value=""></td>
													<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="sgst<?php echo $i;?>" value="<?php echo $sgst[$i];?>" required type="text" name="sgst[]" value="" readonly style="width:45px;border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" required><div id="sgst_valid<?php echo $i;?>"></div></td>
													<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" value="<?php echo $sgstamount[$i];?>" id="sgstamount<?php echo $i;?>" required type="text" name="sgstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="width:80px;border:1px solid #605f5f;" value="">
													<input type="hidden" id="igst<?php echo $i;?>" value="<?php echo $item_result->igst;?>" />
													</td>
													<td class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="igst<?php echo $i;?>"  type="text" name="igst[]" readonly style="width:45px;border:1px solid #605f5f;" value="<?php echo $igst[$i];?>"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="igst_valid<?php echo $i;?>"></div></td>
													<td class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="igstamount<?php echo $i;?>" value="<?php echo $igstamount[$i];?>" type="text" name="igstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="width:80px;border:1px solid #605f5f;" value=""></td>
										...
										<table class="table">
											<tr>
												...
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals"  id="freightcgst"  type="text" name="freightcgst" placeholder="CGST"  value="<?php if($vi['freightcgst']!="") { echo $vi['freightcgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ></td>
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" readonly id="freightcgstamount" placeholder="CGST Amount"  type="text" name="freightcgstamount"   autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['freightcgstamount'];?>"></td>
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightsgst" placeholder="SGST"  type="text" name="freightsgst" readonly value="<?php if($vi['freightsgst']!="") { echo $vi['freightsgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightsgstamount"  type="text" name="freightsgstamount" placeholder="SGST Amount" readonly  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['freightsgstamount'];?>"></td>
	
	
												<td class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightigst"  type="text" name="freightigst"  placeholder="IGST" value="<?php if($vi['freightigst']!="") { echo $vi['freightigst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>
												<td class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightigstamount"  type="text" name="freightigstamount"  placeholder="IGST Amount"  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['freightigstamount'];?>"></td>
											...
											<tr>
												...
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals"  id="loadingcgst"  type="text" name="loadingcgst" placeholder="CGST" value="<?php if($vi['loadingcgst']!="") { echo $vi['loadingcgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="cgst_valid"></div></td>
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" readonly id="loadingcgstamount"  type="text" name="loadingcgstamount"   placeholder="CGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['loadingcgstamount'];?>"></td>
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingsgst" placeholder="SGST"  type="text" name="loadingsgst" readonly value="<?php if($vi['loadingsgst']!="") { echo $vi['loadingsgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>
												<td class="sgst" <?php if($vi['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingsgstamount"  type="text" name="loadingsgstamount" readonly  placeholder="SGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['loadingsgstamount'];?>"></td>
	
	
												<td class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingigst"  type="text" name="loadingigst" placeholder="IGST" value="<?php if($vi['loadingigst']!="") { echo $vi['loadingigst']; } else { echo '0'; } ?>"  style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>
												<td class="igst" <?php if($vi['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingigstamount" placeholder="IGST Amount" type="text" name="loadingigstamount"    autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['loadingigstamount'];?>"></td>
