													...
													*/
													...
													<tbody>
														<tr '.$hide.'>
															...
															<td><input class="" id="itemname'.$i.'"   style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" readonly value="'.$itemname[$i].'" ><div id="itemname_valid"></div><input type="hidden" name="priceType[]" id="priceType'.$i.'" value="Exclusive" ></td>
